...
Функция ДополнитьТекстЗапросЗаполненияСНТ(ТекстЗапроса) Экспорт
	...
	|	И ОсновнойСНТ.Статус В (ЗНАЧЕНИЕ(Перечисление.СтатусыСНТ.НеПросмотрен), ЗНАЧЕНИЕ(Перечисление.СтатусыСНТ.Доставленный), ЗНАЧЕНИЕ(Перечисление.СтатусыСНТ.Созданный), ЗНАЧЕНИЕ(Перечисление.СтатусыСНТ.Подтвержден), ЗНАЧЕНИЕ(Перечисление.СтатусыСНТ.Отклонен))
...
Функция ДополнитьТекстЗапросЗаполненияСНТ_Расход(ТекстЗапроса) Экспорт
	...
	|ГДЕ
	|	ТоварыИсправляемогоСНТ.Ссылка В (ВЫБРАТЬ РАЗЛИЧНЫЕ Товары.СвязанныйСНТ 
	...
	СоответсвиеПолейЗапросов.Вставить("%ТекстПоляТипИзмеряемойВеличины", Новый Структура("ЕдиницаИзмерения",
...
Функция РазделитьМассивСНТ(МассивСНТ) Экспорт
	...
	Запрос.Текст = 
		...
		|	ВТ_СНТ КАК ВТ_СНТ
		|ГДЕ
		|	ВТ_СНТ.Направление = &НаправлениеИмпортныхСНТ
		|	И ВТ_СНТ.ВидВвоза = &ВвидВвозаСНТ
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
		...
		|	ВТ_СНТ КАК ВТ_СНТ
		|ГДЕ
		|	НЕ (ВТ_СНТ.Направление = &НаправлениеИмпортныхСНТ
		|	И ВТ_СНТ.ВидВвоза = &ВвидВвозаСНТ)";
	
	Запрос.УстановитьПараметр("МассивСНТ", МассивСНТ);
	Запрос.УстановитьПараметр("НаправлениеИмпортныхСНТ", Перечисления.НаправленияСНТ.Исходящий);
	Запрос.УстановитьПараметр("ВвидВвозаСНТ", Перечисления.ВидыВвозаСНТ.Импорт);
