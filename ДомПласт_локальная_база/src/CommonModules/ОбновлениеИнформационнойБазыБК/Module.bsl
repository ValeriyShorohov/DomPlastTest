...
Процедура ЗаполнитьПланыВидовРасчетаОрганизации() 
	...
	УстановитьРеквизитыОсновногоНачисленияОрганизации(ПВР.ОкладПоДням, СпРасчета.ПоМесячнойТарифнойСтавкеПоДням, Истина, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, , НеПремия, ИндексируемыйЗаработок);
	УстановитьРеквизитыОсновногоНачисленияОрганизации(ПВР.ОкладПоЧасам, СпРасчета.ПоМесячнойТарифнойСтавкеПоЧасам, Истина, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, , НеПремия, ИндексируемыйЗаработок);
	УстановитьРеквизитыОсновногоНачисленияОрганизации(ПВР.ОкладОтОбратного, СпРасчета.ПоМесячнойТарифнойСтавкеОтОбратного, Истина, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, , НеПремия, ИндексируемыйЗаработок);
	УстановитьРеквизитыОсновногоНачисленияОрганизации(ПВР.ОкладОтОбратногоПоДням, СпРасчета.ПоМесячнойТарифнойСтавкеОтОбратногоПоДням, Истина, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, , НеПремия, ИндексируемыйЗаработок);
	УстановитьРеквизитыОсновногоНачисленияОрганизации(ПВР.ОкладОтОбратногоПоЧасам, СпРасчета.ПоМесячнойТарифнойСтавкеОтОбратногоПоЧасам, Истина, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, , НеПремия, ИндексируемыйЗаработок);
	УстановитьРеквизитыОсновногоНачисленияОрганизации(ПВР.ТарифЧасовой, СпРасчета.ПоЧасовойТарифнойСтавке, Истина, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, , НеПремия, ИндексируемыйЗаработок);
	...
	УстановитьРеквизитыОсновногоНачисленияОрганизации(ПВР.ОплатаПоСреднемуОтп, СпРасчета.ПоСреднемуЗаработкуДляОтпуска, Ложь, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, , НеПремия, ИндексируемыйЗаработок);
	// компенсация отпуска при увольнении
	УстановитьРеквизитыОсновногоНачисленияОрганизации(ПВР.КомпенсацияОтпуска, СпРасчета.ПоСреднемуЗаработкуДляОтпуска, Ложь, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, , НеПремия, ИндексируемыйЗаработок, Истина);
	// компенсация отпуска (без увольнения)
	УстановитьРеквизитыОсновногоНачисленияОрганизации(ПВР.КомпенсацияОтпускаБезУвольнения, СпРасчета.ПоСреднемуЗаработкуДляОтпуска, Ложь, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, Облагается, , НеПремия, ИндексируемыйЗаработок, Истина);
	
	// виды расчета для регистрации прочих доходов 
	УстановитьРеквизитыОсновногоНачисленияОрганизации(ПВР.КомпенсационныеВыплатыПриСлужебныхКомандировках, СпРасчета.ФиксированнойСуммой, Ложь, Облагается, Облагается, Облагается, Облагается, НеОблагается,НеОблагается, НеОблагается, НеОтражатьВБухучете, НеПремия, ИндексируемыйЗаработок);
	УстановитьРеквизитыОсновногоНачисленияОрганизации(ПВР.ПрочиеДоходыОблагаемыеУИсточника, СпРасчета.ФиксированнойСуммой, Ложь, Облагается, НеОблагается, НеОблагается, НеОблагается, НеОблагается, НеОблагается, НеОблагается, НеОтражатьВБухучете, НеПремия, ИндексируемыйЗаработок);
	УстановитьРеквизитыОсновногоНачисленияОрганизации(ПВР.ДоходыНеОблагаемыеУИсточникаВыплаты, СпРасчета.ФиксированнойСуммой, Ложь, НеОблагается, НеОблагается, НеОблагается, НеОблагается, НеОблагается, НеОблагается, НеОблагается, НеОтражатьВБухучете, НеПремия, ИндексируемыйЗаработок);
