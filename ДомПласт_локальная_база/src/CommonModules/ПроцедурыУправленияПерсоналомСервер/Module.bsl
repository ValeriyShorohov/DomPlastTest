...
//
Функция РегламентированныйКалендарьЗаполнен(ДатаНач, ДатаКон) Экспорт 
	...
	Если НЕ КалендарьЗаполнен Тогда
		...
		ОбщегоНазначения.СообщитьПользователю(ТекстСообщения + ?(Найти(ТекстСообщения,",")=0," год!"," годы!"));
	КонецЕсли;
