...
Процедура ФизЛицоПриИзменении(Элемент)
	...
	Если ЗначениеЗаполнено(Объект.Контрагент) Тогда
		...
		ПодставитьРеквизитыФизЛица(ЭтаФорма, Объект.Контрагент);
...
Процедура СубконтоДтБУ1ПриИзменении(Элемент)
	...
	ИначеЕсли ТипЗнч(Объект.СубконтоДтБУ1) = Тип("СправочникСсылка.ФизическиеЛица") Тогда
		ПодставитьРеквизитыФизЛица(ЭтаФорма, Объект.СубконтоДтБУ1);
	КонецЕсли;
...
&НаКлиентеНаСервереБезКонтекста
Процедура ПодставитьРеквизитыФизЛица(ЭтаФорма, ФизЛицо) Экспорт
	...
	Объект.Выдать = ОбщегоНазначенияБККлиентСервер.ПреобразоватьФИОВДательныйПадеж(СтруктураФИО, ДанныеОФизЛице.НеСклонятьФамилию, ДанныеОФизЛице.Пол);
