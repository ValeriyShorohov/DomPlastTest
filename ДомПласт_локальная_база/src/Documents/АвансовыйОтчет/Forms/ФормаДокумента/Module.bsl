...
Процедура ПеречислениеПенсионныхВзносовДокументПриИзмененииНаСервере(ДанныеСтроки)
	...
	ДанныеСтроки.ВидВзноса = ?(ПолучитьЗначениеРеквизита(ДанныеСтроки.Документ, "ВидОперации") = 
				ПредопределенноеЗначение("Перечисление.ВидыОперацийОПВПеречислениеВФонды.ПеречислениеОбязательныхПрофессиональныхПенсионныхВзносов"), 
				НСтр("ru = 'ОППВ'"), НСтр("ru = 'ОПВ'"));
