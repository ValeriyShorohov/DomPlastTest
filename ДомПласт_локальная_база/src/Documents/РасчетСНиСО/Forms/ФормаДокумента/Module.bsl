...
Процедура РассчитатьНаСервере(ФизЛицоДляРасчета = Неопределено)
	...
	СтруктураДополнительныхДанных = Новый Структура("РасчетСОДополнительныеДанные, РасчетСНДополнительныеДанные, РасчетОППВДополнительныеДанные, РасчетООСМСДополнительныеДанные"); 
