...
Процедура ЗаполнитьСписокСпособовРасчета()
	...
	ПеречислениеОППВ = (Объект.ВидОперации = Перечисления.ВидыОперацийОПВПеречислениеВФонды.ПеречислениеОбязательныхПрофессиональныхПенсионныхВзносов);
	...
	Для Каждого СпособРасчета Из Перечисления.СпособыРасчетаСуммКПеречислениюОПВ Цикл
		...
		Если УпрощенныйУчетИПНиОПВ ИЛИ УчетПени ИЛИ ПеречислениеОППВ Тогда
...
Функция АвтозаполнениеНаСервере() 
	...
	ПоДаннымОПВ = (Объект.ВидОперации = Перечисления.ВидыОперацийОПВПеречислениеВФонды.ПеречислениеОбязательныхПенсионныхВзносов);
	...
	СтруктураПараметров.Вставить("ПоДаннымОПВ", ПоДаннымОПВ);     	
...
Процедура ВидОперацииПриИзмененииНаСервере()
	...
	УстановитьВидимостьПорядкаЗаполнения(ЭтаФорма);
	Если Объект.ВидОперации =  ПредопределенноеЗначение("Перечисление.ВидыОперацийОПВПеречислениеВФонды.ПеречислениеОбязательныхПрофессиональныхПенсионныхВзносов") Тогда
...
Процедура ПодготовитьСправкуФормы(Форма) 
	...
	ВидОПВ = ?(Объект.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийОПВПеречислениеВФонды.ПеречислениеОбязательныхПенсионныхВзносов"), "ОПВ", "ОППВ");
