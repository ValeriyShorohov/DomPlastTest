...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	//***** Данил 22.02.2020 
    //Без учета (было реализованого товара меньше, чем возвращается)
	dm_БезУчетаБылоРеализованогоТовараМеньшеЧемВозвращается(ПараметрыПроведения,ТаблицаВозвращенныеСписанныеТовары,Отказ);
	//----- Данил 22.02.2020	
...
//***** Данил 22.02.2020 
//Без учета (было реализованого товара меньше, чем возвращается)
Функция dm_БезУчетаБылоРеализованогоТовараМеньшеЧемВозвращается(ПараметрыПроведения,ТаблицаВозвращенныеСписанныеТовары,Отказ)
	
		
КонецФункции //----- Данил 22.02.2020
