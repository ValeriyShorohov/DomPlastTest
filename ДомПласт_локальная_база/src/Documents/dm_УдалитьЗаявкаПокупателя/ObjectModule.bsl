...
//	//	ДанныеОтветственного	= ПроцедурыУправленияПерсоналом.ДанныеФизЛица(Шапка.Организация, Шапка.Ответственный, Дата); 
...
////
//Процедура СозданиеРеализацииНаОснованииЗаявкиПокупателя(Основание,ПризнакОткрытияДокумента)Экспорт
//	
//	    ДанныеЗаполнения = Основание;
//	
//		Если ТипЗнч(ДанныеЗаполнения) = Тип("ДокументСсылка.dm_УдалитьЗаявкаПокупателя") Тогда
//			
...
//		СоздатьДокумент.dm_СтатусДокументаXMLЗаявкиРеализация = СтатусДокументаXMLЗаявки;//Перечисления.СтатусЗаявкаПокупателяXML.Не_Участвует;
//		
...
//Процедура ПоискДокументаРеализацияТоваровИУслугПоЗаявкеПокупателя(Поиск_РТУ_на_основании_ЗП)Экспорт
//	
//			
//	Запрос = Новый Запрос;
//	Запрос.Текст = 
...
//	НоваяСтрока = ТабЧастьДокументы.Добавить();
//	
...
//Процедура ПечатьСравнениеПечатьИФайл(ТаблицаЗаявкаФайл) Экспорт
//	
...
//Данные.Параметры.Контрагент = Контрагент; 
//Данные.Параметры.Договор = ДоговорКонтрагента;  
//ТабДок.Вывести(Данные); 

//Метод = Макет.ПолучитьОбласть("Метод"); 
//Метод.Параметры.Значение = "Файл: "+УникальныйНомерЗаявкиПокупателяXML; 
...
//МетодДокумента.Параметры.Значение = "Документ: "+Ссылка; 
