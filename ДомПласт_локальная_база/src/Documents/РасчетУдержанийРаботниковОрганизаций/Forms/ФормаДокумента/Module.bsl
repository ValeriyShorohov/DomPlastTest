...
Процедура ПолучитьПлановыеУдержанияСотрудникаНаСервере (МассивСотрудников)
	...
	|	ЛЕВОЕ СОЕДИНЕНИЕ Документ.РасчетУдержанийРаботниковОрганизаций.Удержания КАК РанееСделанныеУдержания
	|		ЛЕВОЕ СОЕДИНЕНИЕ (" + УчетнаяПолитикаПоПерсоналуОрганизацииТекст + ") КАК ВТ_УчетнаяПолитикаПоПерсоналуОрганизации
	|			ПО РанееСделанныеУдержания.Ссылка.Организация = ВТ_УчетнаяПолитикаПоПерсоналуОрганизации.Организация
	|		ПО РанееСделанныеУдержания.Ссылка <> &парамРегистратор 
	|			И РанееСделанныеУдержания.Ссылка.Проведен
	|			И ВЫБОР
	...
	|								ВЫБОР
	|									КОГДА РанееСделанныеУдержания.Ссылка.Организация.ГоловнаяОрганизация = &парамПустаяОрганизация
	|										ТОГДА РанееСделанныеУдержания.Ссылка.Организация
	|									ИНАЧЕ РанееСделанныеУдержания.Ссылка.Организация.ГоловнаяОрганизация
	|								КОНЕЦ
	|							ИНАЧЕ РанееСделанныеУдержания.Ссылка.Организация
	|						  КОНЕЦ = &парамГоловнаяОрганизация
	|				ИНАЧЕ РанееСделанныеУдержания.Ссылка.Организация = &парамОрганизация
	|			КОНЕЦ
	|			И РанееСделанныеУдержания.ФизЛицо = ПлановыеУдержания.ФизЛицо 
	|			И РанееСделанныеУдержания.Ссылка.ПериодРегистрации = &парамНачало 
