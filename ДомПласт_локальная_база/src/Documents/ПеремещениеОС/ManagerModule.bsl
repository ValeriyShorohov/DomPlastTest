	...
	Пока ШапкаДокумента.Следующий() Цикл
		...
		Если ВедетсяАналитическийУчет Тогда 
			...
			Запрос.Текст = "ВЫБРАТЬ РАЗРЕШЕННЫЕ
			               ...
			               |ИЗ
			               |	РегистрБухгалтерии.Типовой.Остатки(&Дата, Счет В ИЕРАРХИИ (&СчетОС), &ВидыСубконтоОС, Субконто1 В (&МассивОС)) КАК ТиповойОстатки
			               |
			               |ОБЪЕДИНИТЬ
			               |
			               |ВЫБРАТЬ
			               ...
			               |ИЗ
			               |	РегистрБухгалтерии.Типовой.Остатки(&Дата, Счет В ИЕРАРХИИ (&СчетАмортизации), &ВидыСубконтоОС, Субконто1 В (&МассивОС)) КАК ТиповойОстатки
			               |;
			               |
			               |////////////////////////////////////////////////////////////////////////////////
			               |ВЫБРАТЬ
